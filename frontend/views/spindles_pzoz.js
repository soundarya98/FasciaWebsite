...
function redraw() {
    d3.select("#svg-spindles-pzoz").remove();
    var chartDiv = document.getElementById("spindles-pzoz");
    var svg = d3.select(chartDiv).append("svg").attr("id", "svg-spindles-pzoz");
