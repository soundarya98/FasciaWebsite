  ...
  function chart(selection) {
    ...
    selection.each(function(data) {
      ...
      var t = d3.transition().duration(duration).ease(d3.easeLinear),
          ...
          z = d3.scaleOrdinal(["#403F4C", "#E84855", "#F9DC5C", "#3185FC", "#EFBCD5"]);
    ...
    .y1(function(d) { return y(d.value); });
      ...
      g.select("g.axis.y")
        .transition(t)
        .attr("class", "axis y")
        .call(d3.axisLeft(y).ticks(6).tickValues([0, 1, 2, 3, 4, 5]).tickFormat(function(d)
        {if(d==1) return "Wake"; if(d==2) return "N1"; if(d==3) return "N2"; if(d==4) return "N3"; if(d==5) return "REM"; else return ""})) ;
